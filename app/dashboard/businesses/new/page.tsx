...
const fileClass =
  "mt-1 w-full cursor-pointer rounded-xl border border-dashed border-stone-300 px-3 py-2 text-sm text-stone-600 file:mr-3 file:rounded-lg file:border-0 file:bg-emerald-50 file:px-3 file:py-1.5 file:text-xs file:font-medium file:text-emerald-700 hover:border-emerald-300";
      ...
      <form action={createBusiness} className="space-y-6">
        ...
        <Card className="p-6">
          ...
          <div className="space-y-4">
            <Field label="📦 Foto del producto a promocionar (fondo blanco)">
              <input type="file" name="productPhoto" accept="image/*" className={fileClass} />
            </Field>
            <Field label="🏷️ Logo del negocio">
              <input type="file" name="logo" accept="image/*" className={fileClass} />
            </Field>
            <Field label="🧑 Foto del dueño/a (fondo blanco)">
              <input type="file" name="founderPhoto" accept="image/*" className={fileClass} />
            </Field>
          </div>
        ...
        >
          Crear negocio y armar la marca
        </SubmitButton>
      </form>
    </div>
  );
