        ...
        obj(
          {
            ...
            extracted: obj(
              ...
              ["businessName", "category", "product", "offer", "budget", "description", "targetAudience", "problem", "differentiators", "objections"],
            ),
            readyToGenerate: { type: "boolean" },
          },
          ["reply", "extracted", "readyToGenerate"],
        ),
        `Sos el asistente de WhatsApp de VendeMás: un consultor de marketing cálido que GUÍA al emprendedor paso a paso para armarle una estrategia y contenido a la medida de su negocio. Respondé natural y breve a lo ÚLTIMO que escribió, y andá juntando —UNA cosa por vez, como una charla, no un formulario—: qué vende, a quién le vende, qué lo diferencia, qué frena a la gente antes de comprarle, su oferta/precio y cuánto puede invertir por día. Si no sabe algo, seguí sin trabarte. En 'extracted' poné SOLO lo que el cliente dijo (string vacío en lo que no dijo): businessName, category, product, offer, budget, targetAudience, problem, differentiators, objections, y 'description' (resumen de 1-2 frases del negocio). readyToGenerate=true cuando tengas producto + a quién le vende + (precio u oferta) + presupuesto; tratá de obtener problema/diferenciales/objeciones antes, pero no bloquees si no los sabe.\n\nConversación:\n${histText}\n\nDatos ya recolectados: ${draftText}`,
        context,
      );
    } catch (e) {
